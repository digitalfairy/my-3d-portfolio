...
Command: npx gltfjsx@6.5.3 public/models/room_scene.glb 
*/
...
export function Model(props) {
  const { nodes, materials } = useGLTF('/room_scene.glb')
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.MousePad.geometry} material={materials.M_MousePad} position={[0.283, 1.178, -0.717]} />
      <group position={[0.275, 1.197, -0.718]}>
      ...
      <mesh geometry={nodes.Cable1.geometry} material={materials.M_Cable} position={[-0.29, 0.969, -1.074]} />
      <mesh geometry={nodes.Cable2.geometry} material={materials.M_Cable} position={[-0.654, 1.067, -1.261]} />
      <group position={[-0.283, 1.193, -0.865]}>
...
useGLTF.preload('/room_scene.glb')
